          ...
          items={[
            {
              ...
              children: (
                <p>
                  The Smart Insurance Platform is an innovative digital platform
                  that provides individuals and businesses with convenient and
                  personalized insurance solutions. It leverages advanced
                  technologies such as artificial intelligence, machine
                  learning, and data analytics to offer seamless insurance
                  experiences and optimize coverage plans.
                </p>
              ),
              showArrow: false,
            },
          ...
          items={[
            {
              ...
              children: (
                <p>
                  The platform utilizes sophisticated algorithms to analyze user
                  data and provide customized insurance recommendations. Users
                  can input their relevant information, such as personal
          ...
          items={[
            {
              ...
              children: (
                <p>
                  Absolutely! The platform allows you to conveniently manage all
                  your insurance policies in one place including existing
                  policies that were not even bought through the platform. Once
                  you have purchased a policy through the platform, you can
                  access your policy information, make updates, file claims, and
                  track the status of your claims seamlessly.
                </p>
              ),
              showArrow: false,
            },
          ...
          items={[
            {
              ...
              children: (
                <p>
                  Security and privacy are of utmost importance to us. The Smart
                  Insurance Platform employs robust security measures to
                  safeguard your personal information. We adhere to
                  industry-standard data encryption protocols and follow strict
                  privacy guidelines. Your data is only used to provide
          ...
          items={[
            {
              ...
              children: (
                <p>
                  ...
                  provided by our insurance partners (Insurers). We recommend
                  reviewing the final quotes and policy details before making a
                  purchase decision.
                </p>
              ),
              showArrow: false,
          ...
          items={[
            {
              ...
              children: (
                <p>
                  ...
                  where there is internet connectivity. We are actively working
                  to expand our reach and serve customers in more regions.
                </p>
              ),
              showArrow: false,
            },
          ...
          items={[
            {
              ...
              children: (
                <p>
                  Yes, you can cancel or modify your insurance policy as per the
                  terms and conditions provided by the insurance provider. The
                  Smart Insurance Platform provides easy policy management
                  features, allowing you to make updates or cancellations based
                  on the specific guidelines of your policy. Please note that
                  cancellation or modification may be subject to certain
                  limitations or fees.
                </p>
              ),
              showArrow: false,
          ...
          items={[
            {
              ...
              children: (
                <p>
                  The Smart Insurance platform simplifies the claims process by
          ...
          items={[
            {
              ...
              children: (
                <p>
                  ...
                  Personalized insurance recommendations based on your specific
                  needs <br /> - Access to multiple insurance providers and
                  policies in one place <br />- Real-time quotes and policy
                  comparisons <br />- Efficient policy management and claims
                  processing <br /> - Enhanced transparency and control over
